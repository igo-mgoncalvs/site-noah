    ...
    <div id="celulas" className={styles.background} >
      ...
      <div className={styles.cellsContainer}>
        ...
        <div className={styles.cells_text}>
          <p>
            As células são grupos de pessoas que se reúnem nos lares, buscando a presença de Deus e compartilhando a palabra de forma presencial uma vez na semana. Com isso nós cremos que as células são as extenções da igreja nos lares.<br/>
            ...
            <br/>Se você está na cidade de mauá ou região e tem interesse em<br/>{"participar de alguma célula, participe de algum prédio No'ah "}<br/>e faça parte deste corpo!
          </p>
        </div>
      </div>
    </div>

    ...
    <div className={styles.ministriesContainer} id="ministerios">
      ...
      <div className={styles.ministries_list}>
        <div className={styles.ministries_item}>
          <Image style={{width: '30vw', height: '25vw'}} className={styles.image} src={image1} alt=''/>
          <div>
        ...
        <div className={styles.ministries_item}>
          <Image style={{width: '30vw', height: '25vw'}} className={styles.image} src={image3} alt=''/>
          <div>
        ...
        <div className={styles.ministries_item}>
          <Image style={{width: '30vw', height: '25vw'}} className={styles.image} src={image4} alt=''/>
          <div>
        ...
        <div className={styles.ministries_item}>
          <Image style={{width: '30vw', height: '25vw'}} className={styles.image} src={image5} alt=''/>
          <div>
